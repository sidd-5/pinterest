...
export default function Navbar() {
  ...
  return (
    <nav style={{ backgroundColor: '#ffffff', position: 'sticky', top: 0, zIndex: 100, borderBottom: '1px solid var(--border-dark)' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '1.25rem 1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'relative' }}>
        
        {/* Brand Logo */}
        <Link href="/" style={{ fontSize: '1.2rem', fontWeight: '900', letterSpacing: '-0.03em', textTransform: 'uppercase' }}>
